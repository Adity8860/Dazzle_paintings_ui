    ...
    <div className="bg-background text-foreground">
      ...
      <div className="flex flex-col md:flex-row max-w-9xl mx-auto   overflow-hidden shadow-md dark:shadow-gray-800">
        ...
        <div className="w-full flex flex-col items-start justify-center md:w-1/2 bg-[#ff7d67] dark:bg-[#e06a56] p-6 sm:p-8 md:p-12 text-white">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 md:mb-6">Hello and Welcome</h2>
          <p className="text-sm md:text-base leading-relaxed mb-6 md:mb-8">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec magna purus,
            malesuada at scelerisque vitae, luctus ac lorem. Aenean convallis ut ligula ut
            placerat. Mauris a eros in velit feugiat pharetra consectetur at eros. Suspendisse at
            massa purus. Aliquam non sollicitudin enim. Maecenas arcu sapien, porta ut sem
            at, pulvinar fringilla quam. Etiam viverra quam ut sapien condimentum.
            Suspendisse eros ante, ultricies ac imperdiet id, inceptos himenaeos. Aliquam id
            leo elementum, iaculis justo a, hendrerit ligula.
          </p>
