        ...
        <div className="absolute inset-0 flex items-center justify-center px-3 sm:px-4 z-10">
          <div className="text-center max-w-[90%] sm:max-w-[85%] md:max-w-[80%] relative z-20">
            ...
            <p className="text-sm xs:text-base sm:text-lg md:text-xl text-white leading-relaxed drop-shadow-lg fade-in delay-200">
              Restore the beauty of your property with our expert power washing solutions
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:py-16 md:py-20">
        <div className="text-center mb-12">
          ...
          <h3 className="text-lg sm:text-xl text-gray-700 dark:text-gray-300 font-medium fade-in delay-200">
            Driveways | Decks | Siding | Patios | Fences | Commercial Properties
          </h3>
        </div>
        ...
        <div className="mb-12 text-center sm:text-left">
          <p className="text-base sm:text-lg text-gray-600 dark:text-gray-400 max-w-4xl mx-auto leading-relaxed fade-in delay-400">
            At Danzzel Painting, we offer comprehensive power washing services to restore and maintain the appearance of your property. Our professional-grade equipment and experienced technicians can safely remove dirt, grime, mold, mildew, and other contaminants from virtually any exterior surface.
          </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <p className="text-gray-600 dark:text-gray-300 fade-in delay-800">
                  Power washing is an essential maintenance service that not only enhances your property's curb appeal but also helps prevent damage caused by built-up dirt, algae, and other harmful substances. Regular power washing can extend the life of your exterior surfaces and save you money on costly repairs.
                </p>
                <p className="text-gray-600 dark:text-gray-300 fade-in delay-1000">
                  Our team uses environmentally friendly cleaning solutions and adjustable pressure settings to ensure effective cleaning without damaging delicate surfaces. We tailor our approach to each specific surface and level of contamination.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 sm:py-16 md:py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-6 hover:shadow-lg transition-all duration-300 fade-in delay-300">
              ...
              <h3 className="text-xl font-bold text-center text-gray-900 dark:text-white mb-3">Residential Power Washing</h3>
              <p className="text-gray-600 dark:text-gray-300 text-center mb-4">
                Enhance your home's curb appeal with our comprehensive residential power washing services. We clean siding, driveways, walkways, decks, patios, fences, and more.
              </p>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-6 hover:shadow-lg transition-all duration-300 fade-in delay-400">
              ...
              <h3 className="text-xl font-bold text-center text-gray-900 dark:text-white mb-3">Commercial Power Washing</h3>
              <p className="text-gray-600 dark:text-gray-300 text-center mb-4">
                Maintain a professional appearance for your business with our commercial power washing services. We clean storefronts, sidewalks, parking lots, and more.
              </p>
              <ul className="space-y-2 text-gray-600 dark:text-gray-300">
                <li className="flex items-start">
                  <svg className="h-5 w-5 text-[#FF69B4] mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-6 hover:shadow-lg transition-all duration-300 fade-in delay-500">
              ...
              <h3 className="text-xl font-bold text-center text-gray-900 dark:text-white mb-3">Specialty Power Washing</h3>
              <p className="text-gray-600 dark:text-gray-300 text-center mb-4">
                We offer specialized power washing services for unique surfaces and challenging cleaning situations that require extra care and expertise.
              </p>
              <ul className="space-y-2 text-gray-600 dark:text-gray-300">
                <li className="flex items-start">
                  <svg className="h-5 w-5 text-[#FF69B4] mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:py-16 md:py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 fade-in delay-300">
            ...
            <h3 className="text-lg font-bold text-center text-gray-900 dark:text-white mb-2">Enhances Curb Appeal</h3>
            <p className="text-gray-600 dark:text-gray-300 text-center">
              Power washing instantly improves the appearance of your property, making it look fresh, clean, and well-maintained.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 fade-in delay-400">
            ...
            <h3 className="text-lg font-bold text-center text-gray-900 dark:text-white mb-2">Prevents Damage</h3>
            <p className="text-gray-600 dark:text-gray-300 text-center">
              Regular power washing removes harmful substances like mold, mildew, and algae that can cause deterioration and decay over time.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 fade-in delay-500">
            ...
            <h3 className="text-lg font-bold text-center text-gray-900 dark:text-white mb-2">Increases Property Value</h3>
            <p className="text-gray-600 dark:text-gray-300 text-center">
              A clean, well-maintained exterior can significantly increase your property's market value and appeal to potential buyers.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 fade-in delay-600">
            ...
            <h3 className="text-lg font-bold text-center text-gray-900 dark:text-white mb-2">Healthier Environment</h3>
            <p className="text-gray-600 dark:text-gray-300 text-center">
              Removing allergens like mold, mildew, and pollen creates a healthier environment for you, your family, and your customers.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 fade-in delay-700">
            ...
            <h3 className="text-lg font-bold text-center text-gray-900 dark:text-white mb-2">Prepares Surfaces for Painting</h3>
            <p className="text-gray-600 dark:text-gray-300 text-center">
              Power washing provides the clean surface needed for proper paint adhesion, making it an essential step before exterior painting projects.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 fade-in delay-800">
            ...
            <h3 className="text-lg font-bold text-center text-gray-900 dark:text-white mb-2">Cost-Effective Maintenance</h3>
            <p className="text-gray-600 dark:text-gray-300 text-center">
              Regular power washing is far less expensive than repairing or replacing surfaces damaged by dirt, mold, and other contaminants.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 sm:py-16 md:py-20">
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-8 md:p-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-4">Ready to Restore Your Property's Beauty?</h2>
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  Our professional power washing services can transform your property's appearance and protect your investment. Contact us today to discuss your project and receive a detailed quote.
                </p>
