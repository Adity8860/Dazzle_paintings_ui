      ...
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <div className="flex items-center mt-1 space-x-3">
            <a
              href="/"
              className="text-gray-500 dark:text-gray-400 transition-colors duration-300 hover:text-[#FF69B4] dark:hover:text-[#FF69B4]"
            >
      ...
      <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t border-gray-200 dark:border-gray-700 lg:flex-row">
        ...
        <ul className="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
          ...
          <li>
            <a
              href="/"
              class="text-sm text-gray-600 dark:text-gray-400  transition-colors duration-300 hover:text-deep-purple-accent-400"
            >
              Privacy Policy
            </a>
          </li>
