        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="space-y-3 sm:space-y-4">
              {/* Section 1 */}
              <div className={`rounded-2xl overflow-hidden transition-all duration-300 ${openSection === 1 ? 'bg-[#00A3FF]' : 'bg-white dark:bg-gray-800 border dark:border-gray-700'}`}>
                <button 
                  className="flex items-center justify-between w-full p-4"
                  onClick={() => setOpenSection(openSection === 1 ? null : 1)}
                >
                  <div className="flex items-center gap-3">
                    <svg xmlns="http://www.w3.org/2000/svg" className={`w-6 h-6 ${openSection === 1 ? 'text-white' : 'text-[#00A3FF]'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              {/* Section 2 */}
              <div className={`rounded-2xl overflow-hidden transition-all duration-300 ${openSection === 2 ? 'bg-[#00A3FF]' : 'bg-white dark:bg-gray-800 border dark:border-gray-700'}`}>
                <button 
                  className="flex items-center justify-between w-full p-4"
                  onClick={() => setOpenSection(openSection === 2 ? null : 2)}
                >
                  <div className="flex items-center gap-3">
                    <svg xmlns="http://www.w3.org/2000/svg" className={`w-6 h-6 ${openSection === 2 ? 'text-white' : 'text-[#00A3FF]'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              {/* Section 3 */}
              <div className={`rounded-2xl overflow-hidden transition-all duration-300 ${openSection === 3 ? 'bg-[#00A3FF]' : 'bg-white dark:bg-gray-800 border dark:border-gray-700'}`}>
                <button 
                  className="flex items-center justify-between w-full p-4"
                  onClick={() => setOpenSection(openSection === 3 ? null : 3)}
                >
                  <div className="flex items-center gap-3">
                    <svg xmlns="http://www.w3.org/2000/svg" className={`w-6 h-6 ${openSection === 3 ? 'text-white' : 'text-[#00A3FF]'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              {/* Section 4 */}
              <div className={`rounded-2xl overflow-hidden transition-all duration-300 ${openSection === 4 ? 'bg-[#00A3FF]' : 'bg-white dark:bg-gray-800 border dark:border-gray-700'}`}>
                <button 
                  className="flex items-center justify-between w-full p-4"
                  onClick={() => setOpenSection(openSection === 4 ? null : 4)}
                >
                  <div className="flex items-center gap-3">
                    <svg xmlns="http://www.w3.org/2000/svg" className={`w-6 h-6 ${openSection === 4 ? 'text-white' : 'text-[#00A3FF]'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
              ...
              <div className="flex items-center justify-center p-4 sm:p-6 bg-gray-50 dark:bg-gray-800 rounded-lg hover:shadow-lg transition-shadow border border-gray-100 dark:border-gray-700">
                <div className="border-2 border-gray-400 dark:border-gray-500 p-2 sm:p-3">
                  <span className="text-lg sm:text-xl font-medium text-gray-400 dark:text-gray-500 tracking-wider">NY</span>
                </div>
              </div>
            </div>
          </div>
