      ...
      <div>
        <div className="relative h-[100svh]">
          ...
          <div className="absolute bottom-0 left-0 right-0 z-10 h-1/4 md:h-1/3 flex flex-col justify-between">
            {[...Array(15)].map((_, i) => {
              // Calculate height based on index - starts larger at top, gets smaller toward bottom
        ...
        <div className="bg-background dark:bg-black transition-colors duration-300">
          <div className="max-w-7xl mx-auto py-24 px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="group flex flex-col items-center text-center p-6 rounded-xl bg-white dark:bg-gray-800/50 hover:shadow-xl dark:hover:bg-gray-800 transition-all duration-300 hover:-translate-y-1">
